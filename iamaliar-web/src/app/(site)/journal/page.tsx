      ...
      <div className="container-site">
        <FadeIn>
          <div className="mb-16">
            ...
            <h1 className="font-serif text-4xl md:text-5xl text-[#111111] font-light">Journal</h1>
          ...
          <FadeIn delay={0.1}>
            <Link href={`/journal/${mockJournals[0].slug}`} className="group block mb-16 md:mb-20">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-center">
                ...
                <div>
                  <p className="text-xs tracking-[0.2em] uppercase text-[#9CA3AF] mb-3">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {mockJournals[0].tags.map((tag) => (
                      <span
                        key={tag}
                        className="text-[10px] text-[#9CA3AF] border border-[#E5E2DC] px-2 py-0.5 tracking-wide"
                      >
                        #{tag}
                      </span>
                    ))}
        ...
        {/* Divider */}
        <div className="border-t border-[#E5E2DC] mb-16" />
          ...
          {mockJournals.slice(1).map((post, i) => (
            <FadeIn key={post.id} delay={i * 0.1}>
              <Link href={`/journal/${post.slug}`} className="group block">
                ...
                <h3 className="font-serif text-xl text-[#111111] font-light mb-3 group-hover:opacity-70 transition-opacity leading-snug">
                  {post.title}
                </h3>
                {post.excerpt && (
