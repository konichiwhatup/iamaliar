...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    ...
    >
      {/* Image */}
      <div className="relative overflow-hidden bg-[#EBEBEB] aspect-[3/4] mb-4">
        <Image
        ...
        {isSold && (
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="bg-[#F5F3EF]/80 px-4 py-2">
              <span className="text-xs tracking-[0.2em] uppercase text-[#9CA3AF]">
      ...
      <div className="space-y-1">
        <div className="flex items-start justify-between gap-2">
          <div>
            ...
            <p className="text-xs text-[#6B7280] tracking-wide mt-0.5">{product.title}</p>
          </div>
          <StatusBadge status={product.status} className="shrink-0 mt-0.5" />
        </div>
        <p className="text-sm text-[#111111] tracking-wide">
