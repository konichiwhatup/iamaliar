...
function FaqItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div className="border-b border-[#1C1C1C]">
      ...
      >
        <span className="text-sm text-[#E8E5DF] leading-relaxed">{q}</span>
        <span className="shrink-0 mt-0.5 text-[#555555]">
      ...
      >
        <p className="text-sm text-[#888888] leading-relaxed pl-0">{a}</p>
      </div>
    </div>
  );
}
      ...
      <div className="container-site max-w-3xl">
        <FadeIn>
          <div className="mb-16">
            ...
            <h1 className="font-serif text-4xl md:text-5xl text-[#E8E5DF] font-light">FAQ</h1>
        ...
        <div className="space-y-12 md:space-y-16">
          {faqs.map((section, i) => (
            <FadeIn key={section.category} delay={i * 0.1}>
              <h2 className="text-xs tracking-[0.2em] uppercase text-[#E8E5DF] mb-6 pb-3 border-b border-[#1C1C1C]">
                {section.category}
              </h2>
              <div>
