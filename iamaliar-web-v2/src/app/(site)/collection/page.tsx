      ...
      <div className="container-site">
        ...
        <FadeIn>
          <div className="mb-12 md:mb-16">
            <p className="text-xs tracking-[0.25em] uppercase text-[#555555] mb-3">
              IAMALIAR
            </p>
        ...
        {/* Filters + View Toggle */}
        <FadeIn delay={0.1}>
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10 pb-6 border-b border-[#1C1C1C]">
            <div className="flex flex-wrap items-center gap-4">
              ...
              <select
                ...
                className="text-xs tracking-[0.1em] text-[#888888] bg-transparent border border-[#1C1C1C] px-3 py-1.5 hover:border-[#E8E5DF] transition-colors outline-none cursor-pointer"
              >
            ...
            <div className="flex items-center gap-2">
              <span className="text-xs text-[#555555] mr-2">{filteredProducts.length} works</span>
              <button
                onClick={() => setView("grid")}
                className={cn(
                  "p-2 transition-colors",
                  view === "grid" ? "text-[#E8E5DF]" : "text-[#2E2E2E] hover:text-[#888888]"
                )}
              ...
              <button
                ...
                className={cn(
                  "p-2 transition-colors",
                  view === "editorial" ? "text-[#E8E5DF]" : "text-[#2E2E2E] hover:text-[#888888]"
                )}
        ...
        {filteredProducts.length === 0 ? (
          <div className="py-20 text-center text-[#555555] text-sm">
            作品が見つかりませんでした。
          </div>
        ) : (
          <div
