              ...
              <Link href={`/lookbook/${lb.slug}`} className="group block">
                ...
                >
                  ...
                  <div className={i % 2 === 1 ? "md:order-1" : ""}>
                    ...
                    {lb.description && (
                      <p className="text-sm text-[#888888] leading-relaxed mb-8 max-w-sm">
                        {lb.description}
                      </p>
                    )}
                    {lb.theme && (
                      <p className="text-xs text-[#555555] tracking-[0.15em] mb-8">
                        Theme: {lb.theme}
                      </p>
                    )}
                    <span className="inline-flex items-center gap-2 text-xs tracking-[0.15em] uppercase text-[#E8E5DF] link-underline">
                      View Lookbook
